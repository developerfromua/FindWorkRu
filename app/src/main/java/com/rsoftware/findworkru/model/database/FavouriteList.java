...
public class FavouriteList {
    ...
    private String vacancyServerUid;
    ...
    //   private int id;
    @Ignore
    public FavouriteList(String vacancyServerUid) {
        this.vacancyServerUid = vacancyServerUid;
    }

    public FavouriteList(@NotNull String vacancyServerUid, String vacancy_name, String vacancy_salary, String vacancy_description, String date, String category, String education, String work_exp, String business, String schedule, String city, String phone, String company) {
        this.vacancyServerUid = vacancyServerUid;
...
//    }
    ...
    public String getVacancyServerUid() {
        return vacancyServerUid;
    }

    public void setVacancyServerUid(String vacancyServerUid) {
        this.vacancyServerUid = vacancyServerUid;
    }
}
